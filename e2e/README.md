...
78 tests total. Generated by `scripts/generate-e2e-inventory.mjs`. Re-run after adding or removing tests.
...
- `e2e/standalone/web-provider.spec.ts:24` — drives an agent end-to-end over HTTP with no CLI, transcript, or terminal (Standalone / web provider)
